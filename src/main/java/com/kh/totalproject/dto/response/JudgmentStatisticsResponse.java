 ...
 */
public record JudgmentStatisticsResponse(
        Map<CodeChallengeDifficulty, Map<CodeChallengeLanguage, JudgmentStatistic>> statistics
) {
    public record JudgmentStatistic(
            int passedCount,
            int failedCount,
            int totalCount,
