...
const Roadmap_Backend = (): JSX.Element => {
  ...
  const getImageSrc = (): string => {
    return theme.palette.mode === 'light'
      ? '/images/roadmap/roadmap_be_p_light.png'
      : '/images/roadmap/roadmap_be_p.png';
  };
    ...
    <>
      <Wrap ref={mainContentRef}>
        <Container>
          ...
          <RightContainer>
            <PageTitleBar>백엔드 개발자 로드맵</PageTitleBar>
            <ImageBox src={imageSrc} alt="백엔드 개발자 로드맵" />
          </RightContainer>
        </Container>
        <ScrollToTopButton />
      </Wrap>
