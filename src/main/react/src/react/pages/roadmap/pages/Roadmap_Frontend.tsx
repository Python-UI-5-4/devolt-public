...
const Roadmap_Frontend = (): JSX.Element => {
  ...
  const getImageSrc = (): string => {
    return theme.palette.mode === 'light'
      ? '/images/roadmap/roadmap_fe_p_light.png'
      : '/images/roadmap/roadmap_fe_p.png';
  };
    ...
    <>
      <Wrap ref={mainContentRef}>
        <Container>
          ...
          <RightContainer>
            <PageTitleBar>프론트엔드 개발자 로드맵</PageTitleBar>
            <ImageBox src={imageSrc} alt="프론트엔드 개발자 로드맵" />
          </RightContainer>
        </Container>
        <ScrollToTopButton />
      </Wrap>
