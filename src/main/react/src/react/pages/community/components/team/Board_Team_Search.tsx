...
import { BoardSearchProps, TeamType } from '../../CommunityType';
import { TeamDisplayNames } from '../common/DisplayNames';

const Board_Team_Search: React.FC<BoardSearchProps> = ({
  onSearchChange,
  onEnumFilterRefresh,
  enumFilter,
}) => {
      ...
      <SearchContainer>
        ...
        <TagSearchContainer>
          <TagSearchBox theme={theme.palette.mode}>
            <TagSearch>
              {enumFilter !== null && (
                <TagSearchItem>{TeamDisplayNames[enumFilter as TeamType]}</TagSearchItem>
              )}
            </TagSearch>
          </TagSearchBox>
          <ResetButtonBox
