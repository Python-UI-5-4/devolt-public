...
import { WriteCodingPostRequest } from '../../../../../api/AxiosApi/CommunityApi/CommunityApiType';
...
import { PostWriteEditorCodingPros } from '../../CommunityType';
...
const Post_WriteEditor_Coding: React.FC<PostWriteEditorCodingPros> = ({ title, language }) => {
...
- 서비스 운영 관련 문의는 홈페이지 우측 CS 메뉴를 이용해주세요.`,
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      const data: WriteCodingPostRequest = {
        boardType,
        title,
        language,
      ...
      const response = await CommunityApi.writeCodingPost(data);
      if (response.data) {
