...
import { BoardSearchProps, StudyType } from '../../CommunityType';
import { StudyDisplayNames } from '../common/DisplayNames';

const Board_Study_Search: React.FC<BoardSearchProps> = ({
  onSearchChange,
  onEnumFilterRefresh,
  enumFilter,
}) => {
      ...
      <SearchContainer>
        ...
        <TagSearchContainer>
          <TagSearchBox theme={theme.palette.mode}>
            <TagSearch>
              {enumFilter !== null && (
                <TagSearchItem>{StudyDisplayNames[enumFilter as StudyType]}</TagSearchItem>
              )}
            </TagSearch>
          </TagSearchBox>
          <ResetButtonBox
