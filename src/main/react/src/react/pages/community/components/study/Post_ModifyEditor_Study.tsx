...
import { ModifyStudyPostRequest } from '../../../../../api/AxiosApi/CommunityApi/CommunityApiType';
...
import { PostModifyEditorStudyProps } from '../../CommunityType';
...
const Post_ModifyEditor_Study: React.FC<PostModifyEditorStudyProps> = ({
  boardId,
  content,
  title,
  study,
  ...
  const handleModify = async (): Promise<void> => {
    ...
    try {
      const data: ModifyStudyPostRequest = {
        boardType,
      ...
      const response = await CommunityApi.modifyStudyPost(data);
      if (response.data) {
