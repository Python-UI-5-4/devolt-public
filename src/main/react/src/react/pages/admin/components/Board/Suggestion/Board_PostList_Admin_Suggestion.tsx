...
import type { MyPageSuggestionProps } from '../../../AdminType';
...
const Board_PostList_MyPage_Suggestion: React.FC<MyPageSuggestionProps> = ({
  ...
  const useMySuggestionBoardData = (
    ...
    return useQuery({
      ...
      queryFn: AdminApi.getMySuggestionBoardQuery,
      enabled: !!params,
    });
  };
  ...
  const handlePostClick = (post: SuggestionBoardDataType): void => {
    navigate(`/admin/suggestion/post/${post.suggestionId}`);
  };
