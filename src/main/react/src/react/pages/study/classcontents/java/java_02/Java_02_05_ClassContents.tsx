...
const Java_02_05_ClassContents = (): JSX.Element => {
  const Java_02_05_Code01 = (): JSX.Element => {
    useEffect(() => {
...
while(n > 0) {
  ...
  const Java_02_05_Code02 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public class While {
  ...
  const Java_02_05_Code03 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
while (treeHit < 10) {
  ...
  const Java_02_05_Code04 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public class While {
  ...
  const Java_02_05_Code05 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public static void main(String[]args) {
  ...
  const Java_02_05_Code06 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
  ...
  const Java_02_05_Code07 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public static void main(String[]args) {
  ...
  const Java_02_05_Code08 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public static void main(String[]args) {
  ...
  const Java_02_05_Code09 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
Scanner sc = new Scanner(System.in);
  ...
  const Java_02_05_Code10 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public static void main(String[]args) {
  ...
  const Java_02_05_Code11 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public static void main(String[] args) {
  ...
  const Java_02_05_Code12 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public class Main {
  ...
  const Java_02_05_Code13 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
  ...
  return (
    <>
      <EachClass>
        ...
        <ClassContentsContainer>
          <ClassContentsText>
            반복문이란 주어진 조건이 참인 경우 혹은 주어진 횟수만큼 반복적으로 프로그램을 수행
            합니다.
            <br />
            프로그램이 처리하는 코드의 많은 부분이 반복적으로 수행되는 형태가 많으므로 가장 많이
            사용되는 제어문 입니다.
            <br />
            <br />
            <ClassContentsTextTab>
              ...
              3. for문
              <br />
              4. Enhanced for 문 : 배열이나 컬렉션과 같은 반복 가능한(iterable) 객체를 간편하게
              순회하고 요소에 접근하는 반복문
              <br />
              <br />
            </ClassContentsTextTab>
          ...
          <ClassContentsText>
            ...
            반복 횟수가 명확하지 않거나, 특정 조건이 충족될 때까지 반복해야 하는 경우에 사용됩니다.
            <br />
            <b style={{ color: 'red' }}>
              <b>
                {`while(조건식) {`}
          ...
          <ClassContentsTitle3>잘못 입력된 경우 반복문 계속 수행 (유효값 체크)</ClassContentsTitle3>
          <ClassContentsText>
            <Java_02_05_Code02 />
            <br />
          </ClassContentsText>
          ...
          <ClassContentsText>
            for문내에 초기식, 조건식, 증감식에 대한 식을 가지고 있는 유한의 갯수를 반복 수행할 때
            유용하게 사용 됩니다.
            <br />
          ...
          <ClassContentsText>
            break 문은 루프 내에서 사용하여 해당 반복문을 완전히 종료시킨 뒤, 반복문 바로 다음에
            위치한 명령문을 실행합니다.
            <br />
            즉 루프 내에서 조건식의 판단 결과와 상관없이 반복문을 완전히 빠져나가고 싶을 때
            사용합니다.
            <br />
          ...
          <ClassContentsText>
            continue 문은 루프 내에서 사용하여 해당 루프의 나머지 부분을 건너뛰고, 바로 다음
            조건식의 판단으로 넘어가게 해줍니다.
            <br />
          ...
          <ClassContentsText>
            ...
            <br />
            <ClassContentsCodeBox>
              👉 Math.random(): Math 클래스의 random() 메서드는 0 이상 1 미만의 무작위 실수 값을
              반환합니다.
            </ClassContentsCodeBox>
            <br />
            <Java_02_05_Code11 />
...
export default Java_02_05_ClassContents;
