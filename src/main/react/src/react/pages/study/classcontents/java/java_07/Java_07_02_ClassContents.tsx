...
const Java_07_02_ClassContents = (): JSX.Element => {
  const Java_07_02_Code01 = (): JSX.Element => {
    useEffect(() => {
...
public class GameMain {
  ...
  const Java_07_02_Code02 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
interface GameAction {
  ...
  const Java_07_02_Code03 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public class Character extends Unit implements GameAction {
  ...
  const Java_07_02_Code04 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
...
public class GameThA extends Thread {
  ...
  const Java_07_02_Code05 = (): JSX.Element => {
    useEffect(() => {
      const codeBlocks = document.querySelectorAll('pre code');
      codeBlocks.forEach((block) => {
        // Element를 HTMLElement로 타입 단언
    ...
    <>
      <EachClass>
        ...
        <ClassContentsContainer>
          ...
          <ClassContentsTitle3>
            <b style={{ color: 'var(--devolt-white)' }}>GameMain</b>
          </ClassContentsTitle3>
          <Java_07_02_Code01 />
          <ClassContentsTitle3>
            <b style={{ color: 'var(--devolt-white)' }}>Unit</b>
          </ClassContentsTitle3>
          <Java_07_02_Code02 />
          <ClassContentsTitle3>
            <b style={{ color: 'var(--devolt-white)' }}>Character</b>
          </ClassContentsTitle3>
          <Java_07_02_Code03 />
          <ClassContentsTitle3>
            <b style={{ color: 'var(--devolt-white)' }}>GameThA</b>
          </ClassContentsTitle3>
          <Java_07_02_Code04 />
          <ClassContentsTitle3>
            <b style={{ color: 'var(--devolt-white)' }}>GameThB</b>
          </ClassContentsTitle3>
          <Java_07_02_Code05 />
        </ClassContentsContainer>
      </EachClass>
...
export default Java_07_02_ClassContents;
